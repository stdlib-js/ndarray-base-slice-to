...
```javascript
sliceTo = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-slice-to@v0.2.3-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/ndarray-base-slice-to/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/ndarray-base-slice-to/actions/workflows/test.yml?query=branch:v0.2.3
